...
/////// her the arrow will make a problem so we can't use it in constractor function ///////
...
let Student = function(name, age, hometown) {             // i let the function as it //
  this.name = name;
  this.age = age;
  this.hometown = hometown;
};
...
/*Student.prototype.greeting = ()=> `Hi, my name is ${this.name}`; // here the method don`t work when i put it into array //
*/
...
//  normally  represent the instance of the constructor ( related to the object) , here is undefiend value 
...
//the arrow function don't have acsses to their own this , this not present in the scope of it . 